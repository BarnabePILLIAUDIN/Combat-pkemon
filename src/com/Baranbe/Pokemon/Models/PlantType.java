...
public class PlantType extends Pokemon {
    public PlantType(String nom, float hp, float atk) {
        super(nom, hp, atk);
    }

    public void attack(Pokemon p) {
        if (p.getClass().getSimpleName().equals("WaterType")) {
            p.setHp(p.getHp() - 2 * super.getAtk());
            System.out.println("L'attaque de " + getNom() + " est super efficace");
        } else if (p.getClass().getSimpleName().equals("PlantType") || p.getClass().getSimpleName().equals("FireType")) {
